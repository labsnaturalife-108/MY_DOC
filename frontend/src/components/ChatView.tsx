  ...
  return (
    <div className="flex h-full w-full relative overflow-hidden bg-zinc-50 dark:bg-zinc-950 transition-colors duration-150">
      ...
      <div className="flex-1 flex flex-col h-full max-w-4xl mx-auto w-full p-4 sm:p-6 transition-all">
        ...
        <div className="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-2xl p-3.5 mb-4 shadow-sm dark:shadow-xl flex flex-wrap items-center justify-between gap-3 shrink-0">
          <div className="flex items-center space-x-2.5">
            <div className="w-8 h-8 rounded-xl bg-zinc-100 dark:bg-zinc-800 border border-zinc-250 dark:border-zinc-700/80 flex items-center justify-center text-zinc-700 dark:text-zinc-300">
                ...
                {currentModel.is_local && (
                  <span
                    className={`text-[10px] px-2 py-0.5 rounded-full font-medium flex items-center gap-1 ${
                      isLocalOnline
                        ? "bg-zinc-100 dark:bg-zinc-800 text-emerald-600 dark:text-emerald-400 border border-zinc-200 dark:border-zinc-700"
        ...
        <div className="flex-1 overflow-y-auto space-y-4 pr-1">
          {messages.length === 0 && !streaming && (
            <div className="py-16 text-center space-y-4">
              <div className="w-16 h-16 rounded-2xl bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 text-zinc-700 dark:text-zinc-300 flex items-center justify-center mx-auto shadow-sm">
              ...
              <div className="flex flex-wrap justify-center gap-2 pt-2 max-w-xl mx-auto">
                {quickPrompts.map((prompt, i) => (
                  <button
                    ...
                    className="text-xs bg-white dark:bg-zinc-900 hover:bg-zinc-100 dark:hover:bg-zinc-850 text-zinc-700 dark:text-zinc-300 border border-zinc-200 dark:border-zinc-800 hover:border-zinc-300 dark:hover:border-zinc-700 px-3.5 py-2 rounded-xl transition shadow-sm"
                  >
                    {prompt}
                  </button>
                ))}
          ...
          {streaming && (
            <div className="flex items-start space-x-3">
              <div className="w-8 h-8 rounded-xl bg-zinc-100 dark:bg-zinc-850 border border-zinc-250 dark:border-zinc-700/80 shadow-sm shrink-0 flex items-center justify-center text-zinc-800 dark:text-zinc-200">
                <Bot className="w-4 h-4" />
              </div>

              <div className="max-w-[85%] bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 text-zinc-800 dark:text-zinc-200 rounded-2xl rounded-tl-none p-4 text-xs sm:text-sm leading-relaxed shadow-sm">
                {streamingText ? (
